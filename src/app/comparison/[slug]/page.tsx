...
export function generateStaticParams() {
  return [
    ...
    { slug: "leadhaus-vs-apollo" },
    { slug: "leadhaus-vs-instantly" },
  ];
}
...
const comparisons: Record<string, ComparisonData> = {
  ...
  "leadhaus-vs-apollo": {
    ...
    title: "Leadhaus vs Apollo | Managed Pipeline vs Complex Sales Databases",
    metaDesc: "Compare Leadhaus and Apollo. Apollo is a database tool requiring manual exporting and list building. Leadhaus builds your database and runs outreach.",
    eyebrow: "Leadhaus vs Apollo",
    headline: "You need positive replies, not a database of credits",
    subtitle: "Apollo provides a database of leads and expects your team to do the heavy exporting and sequence management. Leadhaus does all the work for you.",
    comparisonTableTitle: "Managed Pipeline vs Database Credits",
    whyLHHeading: "Why our clients choose Leadhaus over Apollo",
    whyLHText: "Database tools charge you for credits and make you do the labor. You must manage bounce rates, verify contacts, configure inbox settings, and rotate domains to stay out of spam folders. Leadhaus handles everything. We source the contacts, clean the list, run the campaigns, and deliver interested buyers.",
    row1Title: "Lead Sourcing",
    row1LH: "We build custom, targeted lists live for your specific sectors",
    row1Comp: "You must spend database credits to manually build and export lists",
    row2Title: "Deliverability Care",
    row2LH: "Zero config. We manage all secondary domains and warmups.",
    row2Comp: "You must configure domains and track sender reputations yourself",
    row3Title: "Outreach Management",
    row3LH: "Fully managed campaigns. You only step in to close deals.",
    row3Comp: "Your team must manage templates and sequence settings daily",
    summaryText: "If you want your sales team to spend hours exporting CSV files and managing email servers, Apollo is a good tool. If you want them in calls with qualified buyers, Leadhaus is for you.",
  },
  "leadhaus-vs-instantly": {
    competitorName: "Instantly",
    title: "Leadhaus vs Instantly | Sourced Enquiries vs Cold Email Infrastructure",
    metaDesc: "Compare Leadhaus and Instantly. Instantly is an outbound sending tool requiring manual inbox setup. Leadhaus delivers hot sales enquiries with zero setup.",
    eyebrow: "Leadhaus vs Instantly",
    headline: "We deliver meetings, not email software to configure",
    subtitle: "Instantly provides cold email infrastructure for operators who want to build their own setups. Leadhaus does the heavy technical lifting.",
    comparisonTableTitle: "Done For You vs Outbound Software",
    whyLHHeading: "Why our clients choose Leadhaus over Instantly",
    whyLHText: "To scale outreach on software, you must buy multiple domains, configure DNS/SPF/DKIM/DMARC records, buy and verify lists, write copy, and manage a master inbox. Leadhaus handles the entire outbound funnel. We buy the domains, write the sequences, build the list, and handle the inbox.",
    row1Title: "Inbox Configuration",
    row1LH: "Zero setup. We manage domains and deliverability settings.",
    row1Comp: "You must purchase domains and configure DNS records manually",
    row2Title: "Target Data",
    row2LH: "We source and verify your target prospects live weekly",
    row2Comp: "You must import your own lists from external databases",
    row3Title: "Outreach Execution",
    row3LH: "We write the copy, sequence the campaigns, and filter replies",
    row3Comp: "You must write copy templates and monitor sequences yourself",
    summaryText: "If you want a dedicated system to scale cold email operations internally, Instantly is a powerful tool. If you want results without the software management, Leadhaus is the choice.",
  },
};
